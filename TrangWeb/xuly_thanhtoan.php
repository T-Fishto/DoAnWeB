...
try {
    ...
    // TÍNH TOÁN LẠI TỔNG TIỀN (CHỈ CÁC MÓN ĐƯỢC CHỌN) 
    $tong_tien = 0;
    $phi_van_chuyen = 25000;
    
    //Chỉ tính tiền các món trong $items_to_process
    ...
    //  LƯU VÀO BẢNG `chi_tiet_don_hang` ---
    ...
    //Chỉ XÓA các món đã thanh toán khỏi giỏ hàng ★★★
    foreach ($selected_ids as $cart_item_id) {
        if (isset($_SESSION['cart'][$cart_item_id])) {
